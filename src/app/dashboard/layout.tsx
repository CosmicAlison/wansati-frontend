...
import { Briefcase, Calculator, House, MessageCircleMore, PersonStandingIcon } from 'lucide-react';
...
const navItems: NavItem[] = [
  ...
  { name: 'Jobs', href: '/dashboard/jobBoard', icon: Briefcase },
  { name: 'Estimator', href: '/dashboard/salaryCalculation', icon:Calculator },
];
